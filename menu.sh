...
data_ip="https://raw.githubusercontent.com/kyt-team/permission/main/ip"
checking_sc() {
...
Name=$(curl -sS https://raw.githubusercontent.com/kyt-team/permission/main/ip | grep $MYIP | awk '{print $2}')
if [ "$res" = "Expired" ]; then
Exp="\e[36mExpired\033[0m"
else
Exp=$(curl -sS https://raw.githubusercontent.com/kyt-team/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
